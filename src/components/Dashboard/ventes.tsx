...
const VentesComponent: React.FC = () => {
    return (
                    ...
                    <nav aria-label="breadcrumb" className="w-max">
                        <ol className="flex flex-wrap items-center w-full bg-opacity-60 rounded-md bg-transparent p-0 transition-all">
                            ...
                            <li className="flex items-center text-gray-900 antialiased font-sans text-sm font-normal leading-normal cursor-pointer transition-colors duration-300 hover:text-gray-500">
                                <p className="block antialiased font-sans text-sm leading-normal text-gray-900 font-normal">ventes</p>
                            </li>
                        </ol>
                    </nav>
                    <h6 className="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-gray-900">ventes</h6>
                </div>
