            ...
            <div className="fixed flex flex-col top-0 left-0 w-64 bg-gray-900 h-full shadow-lg">
                ...
                <div className="overflow-y-auto overflow-x-hidden flex-grow">
                    ...
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                         xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round"
                                ...
                                <span
                                    className="ml-2 font-semibold text-sm tracking-wide truncate font-sans">Ventes</span>
                            </a>
                        </li>
                        <li>
                            <a href="#"
                ...
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                     xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round"
                                ...
                                <span
                                    className="ml-2 font-semibold text-sm tracking-wide truncate font-sans">Logout</span>
                            </a>
                        </li>
                    </ul>
                </div>
